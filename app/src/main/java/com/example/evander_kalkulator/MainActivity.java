package com.example.evander_kalkulator;
...
import com.example.evander_kalkulator.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void performCalculation(char operator) {
        ...
        switch (operator) {
            ...
            case '÷':
                if (num2 == 0) {
                    Toast.makeText(this, "Tidak dapat dibagi 0", Toast.LENGTH_SHORT).show();
                    return; // jika terdapat pembagian 0 maka melempar value text / exit
                }
                result = num1 / num2;
                break;
            case '%':
            ...
            case '√':
                if (num1 < 0) {
                    Toast.makeText(this, "Tidak dapat melakukan perhitungan minus", Toast.LENGTH_SHORT).show();
                    return; // jika terdapat pembagian minus maka terdapat value text
                }
